...
public class DataSourceCollection: NSObject, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        return collectionView.cell(collectionViewCell: data?[indexPath.section].collectionRows?[indexPath.item].collectionCell ?? UICollectionViewCell.self, forIndex: indexPath, withCellDetails: data?[indexPath.section].collectionRows?[indexPath.item].rowData, controller: controller, indexPath: indexPath)
    }
